...
if not terrain_obj:
    raise ValueError(f"Object '{TERRAIN_NAME}' not found")
...
math_pow_node.inputs[1].default_value = POWER_EXPONENT

# Color ramp config
color_ramp = color_ramp_node.color_ramp
color_ramp.interpolation = COLOR_INTERPOLATION
...
print(f"Nonlinear exponent: {POWER_EXPONENT}, interpolation: {COLOR_INTERPOLATION}")